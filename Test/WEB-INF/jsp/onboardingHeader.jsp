...
<body>
	...
	<div class="topbg" style="margin-top: -15px;">
		<div class="header_container" role="header">
			<div class="logo">
				<a href="#"> <img src="images1/tasec_logos.png" width="97"
			...
			<div class="header_link">
				<div class="top-nav">
					...
					<c:forEach var="onboarddata" items="${onboardlogindata}">
	<tr>
					<c:choose>
						<c:when test="${onboardlogindata == null}">
								...
								<tr>
									<td align="right" valign="middle"><b
										style="text-transform: capitalize;">Welcome
											${onboarddata.su_firstname}
										${onboarddata.su_lastname}</b></td>
										...
										<ul class="newnav pull-right top-menu"
											...
											<li class="dropdown" style="margin: 0px; padding: 0px;"><a
												...
												<!-- 	<li><a href="resetPassword">Change Password</a></li> -->
													<li><a href="logoutonbaording"><i class="icon-key"></i> Log
															Out</a></li>
												</ul></li>
