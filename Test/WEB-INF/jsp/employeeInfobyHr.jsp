...
<form name="employeeinfobyhr" id="employeeinfobyhr" class="form-horizontal" action="empInfobyHrinsertion" method="post">	
          ...
          <div class="form-group">
                 ...
                 <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-6">
							<textarea class="form-control" id="emp_address" name="emp_address"
 ...
 <div class="form-group">
						...
						<div class="col-sm-6">
								<select class="form-control" id="emp_jobcode" name="emp_jobcode">
									<option value="Select">Select Job Code</option>
...
<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="emp_desknumber"
								name="emp_desknumber" placeholder="Enter Desk number"
	...
	<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="emp_startdate"
								name="emp_startdate" placeholder="Click here for Calender"
    ...
    <div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="emp_enddate"
								name="emp_enddate" placeholder="Click here for Calender"
			 ...
			 <div class="form-group">
				...
				<div class="form-group">
						...
						<div class="col-sm-6">
								<select class="form-control" id="emp_worklocation" name="emp_worklocation">
 ...
 <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="emp_costcenter"
								name="emp_costcenter" placeholder="Enter Cost Center"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="emp_department"
								name="emp_department" placeholder="Enter department"
								onfocus="javascript: hideMessage('emp_costcenter_error')">
							<label id="emp_costcenter_error"
								style="display: none; color: red; margin-left: 4px;"></label>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
								<select class="form-control" id="emp_functionofdept" name="emp_functionofdept">
								<option value="Select">Select function of department</option>
