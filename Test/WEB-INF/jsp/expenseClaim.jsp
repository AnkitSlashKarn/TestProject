...
<input type="hidden" value="${pageContext.request.contextPath}" id="contextpath">
			...
			<div class="stipbg">
				...
				<div class="panel-body bio-graph-info">
					...
					<div>
						...
						<div class="panel-heading"
							...
							<strong> <font style="color: white; cursor: pointer;">2.
									Expense Claim</font> <img src="images/rightbluearrow.png"
								align="right"
					...
					<div>
						<div class="panel-heading"
							style="background-color: #002066; margin: 1px 0 1px 0px; border-radius: 0px;">
							<strong> <a href="expenseClaimstatus"> <font
	...
	<div class="form-group">
						...
						<label for="inputPassword" class="col-sm-2 control-label"
							...
							<tr>
							<td  width="17%"><div class="form-control" style="width: 34px;">&#8377;</div></td>
							<td><input type="text" class="form-control" id="exp_amount"
								name="exp_amount" placeholder="Enter the amount"
								onkeypress="javascript: return onlyNumbers(event);"
									onclick="javascript: hideMessage('exp_amount_error')"
								maxlength="10" 	oncopy="return false;" oncut="return false;"
										ondragstart="return false;" ondrop="return false;" onpaste="return false;"/></td>
							</tr>
							</table>
							<label id="exp_amount_error"
							style="display: none; color: red; margin-left: 10px;"></label>
							</div>
